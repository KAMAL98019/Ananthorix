        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeIn direction="right" className="order-2 lg:order-1">
            <div className="w-full aspect-[4/3] rounded-3xl border border-white/10 shadow-[0_0_40px_rgba(24,123,221,0.15)] relative overflow-hidden group">
              <Image 
                src="/images/services/mobile/section2.webp"
                alt="Mobile-First Strategy"
                fill
          ...
          <FadeIn direction="left" className="order-1 lg:order-2 flex flex-col">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
              Native Performance, <span className="text-[#187BDD] drop-shadow-[0_0_15px_rgba(24,123,221,0.5)]">Exceptional Engagement</span>
            </h2>
            <div className="space-y-6 text-[#C1C6D5] text-lg leading-relaxed max-w-lg">
              <p>
                A successful mobile app requires more than just shrinking a website to fit a smaller screen. It demands deep knowledge of mobile hardware capabilities, OS-specific design guidelines, and offline-first architectures.
              </p>
              <p>
                We build mobile experiences that are fluid, reliable, and deeply engaging.
              </p>
            </div>
          </FadeIn>

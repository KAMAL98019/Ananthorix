...
export default function MvpApproach() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeIn direction="right" className="order-2 lg:order-1">
            <div className="w-full aspect-[4/3] bg-[#0b1a30] rounded-3xl border border-white/10 shadow-[0_0_40px_rgba(24,123,221,0.15)] flex flex-col items-center justify-center text-slate-500 relative overflow-hidden group">
              ...
              <span className="text-sm font-medium tracking-widest uppercase">Scalability Placeholder</span>
            </div>
          </FadeIn>
          ...
          <FadeIn direction="left" className="order-1 lg:order-2 flex flex-col">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
              A Minimum Viable Product, Not a <span className="text-[#187BDD] drop-shadow-[0_0_15px_rgba(24,123,221,0.5)]">Minimum Quality</span> Product
            </h2>
            <div className="space-y-6 text-[#C1C6D5] text-lg leading-relaxed max-w-lg">
              <p>
                "Fast" doesn't mean "fragile." Even though we build MVPs rapidly, we write clean, scalable code.
              </p>
              <p>
                When your product gains traction, you won't need to rewrite the entire application; you can simply build on top of the robust foundation we provided.
              </p>
            </div>
          </FadeIn>

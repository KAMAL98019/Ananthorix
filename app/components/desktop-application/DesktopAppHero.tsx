        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeIn direction="right" className="flex flex-col">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
              Robust <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A6C8FF] to-[#187BDD]">Cross-Platform</span> Desktop Software
            </h1>
            <p className="text-[#C1C6D5] text-lg sm:text-xl leading-relaxed max-w-lg">
              High-performance software for the heavy lifters. We engineer powerful, resource-efficient desktop applications for macOS, Windows, and Linux that work seamlessly offline and leverage native computing power.
            </p>
          </FadeIn>

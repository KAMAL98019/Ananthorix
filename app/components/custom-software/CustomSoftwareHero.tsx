        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeIn direction="right" className="flex flex-col">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
              Tailor-Made <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A6C8FF] to-[#187BDD]">Software Solutions</span> for the Modern Enterprise
            </h1>
            <p className="text-[#C1C6D5] text-lg sm:text-xl leading-relaxed max-w-lg">
              Off-the-shelf software rarely fits a growing business perfectly. We engineer robust, scalable, and secure custom software designed specifically for your unique operational needs.
            </p>
          </FadeIn>
          ...
          <FadeIn direction="left" delay={200}>
            ...
            <div className="w-full aspect-[4/3] sm:aspect-video lg:aspect-[4/3] rounded-3xl border border-white/10 shadow-[0_0_40px_rgba(24,123,221,0.15)] overflow-hidden relative group">
              <Image 
                src="/images/services/customsoftware/herobanner.webp"

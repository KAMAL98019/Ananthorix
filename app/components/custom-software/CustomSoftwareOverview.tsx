...
export default function CustomSoftwareOverview() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeIn direction="right" className="order-2 lg:order-1">
            <div className="w-full aspect-[4/3] rounded-3xl border border-white/10 shadow-[0_0_40px_rgba(24,123,221,0.15)] relative overflow-hidden group">
              <Image 
                src="/images/services/customsoftware/engineeredinfinite.webp"
                alt="Engineering Infinite Possibilities"
                fill
          ...
          <FadeIn direction="left" className="order-1 lg:order-2 flex flex-col">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
              Engineering <span className="text-[#187BDD] drop-shadow-[0_0_15px_rgba(24,123,221,0.5)]">Infinite Possibilities</span>
            </h2>
            <div className="space-y-6 text-[#C1C6D5] text-lg leading-relaxed max-w-lg">
              <p>
                When your business outgrows standard SaaS tools, you need architecture that scales with you. We specialize in building complex, high-performance web applications, internal tools, and enterprise resource systems.
              </p>
              <p>
                Our engineering team focuses on clean code, automated testing, and cloud-native infrastructure to ensure your software is a long-term asset, not technical debt.
              </p>
            </div>
          </FadeIn>

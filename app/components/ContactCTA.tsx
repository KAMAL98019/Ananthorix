...
export default function ContactCTA() {
  ...
  return (
    <section id="contact-cta" className="bg-[#030b1a] py-20 px-4 sm:px-6 lg:px-10 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Header section */}
        <FadeIn direction="up" className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 flex flex-col items-center">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <FadeIn direction="up" delay={200}>
            <div className="p-8 sm:p-10 rounded-3xl bg-[#07152D] border border-white/10 shadow-2xl relative overflow-hidden">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-8 relative z-10">Send us a message</h3>
